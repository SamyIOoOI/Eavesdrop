...
### As for the receiver bug, it was straight forward. All I had to do was swap the TLO72 PREAMP with a POWER AMP LM386 to power up speakers/headphones. I also had to get rid of no longer useful components such as the ICL7660 that outputted the -5V Rail as that rail was no longer needed with the removal of the TL072. As for the RF modulation circuit I just needed to reverse the logic. Note that both the Receiver and Sender must be set to equal frequencies to work.
